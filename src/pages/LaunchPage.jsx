  ...
  return <>
    ...
    {section === 'Create launch' && <Panel className="launch-create-builder">
      <div className="launch-create-form">
        ...
        <div className="launch-field-grid">
          <div className="builder-field"><span>Paired with</span><DropdownSelect label="Select quote asset" value={quoteAsset} onChange={setQuoteAsset} options={['GIWA', 'USDC', 'ETH']} /></div>
