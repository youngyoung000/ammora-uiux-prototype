...
import { AssetMark, Badge, Button, DateTimeInput, DropdownSelect, PageTabs, Panel, QuickSelect, SectionHeading, SegmentedControl, WorkspaceHeader } from '../design-system/index.jsx'
    ...
    <Panel className="config-preview quick-config-preview">
      <div>
        ...
        <div className="pool-config-fields">
          ...
          {start === 'Schedule' && <Field label="Trading opens"><DateTimeInput defaultValue="2026-09-12T10:00" label="Select pool opening date and time" /></Field>}
        </div>
      </div>
...
function AdvancedALMMFlow() {
  ...
  return <Panel className="advanced-creation-workspace" id="advanced-almm-flow">
    <div className="creation-form">
      ...
      <CreationSection step="04" title="Pool activation"><SegmentedControl items={['Start now', 'Schedule']} value={activation} onChange={setActivation} label="Pool activation" />{activation === 'Schedule' && <Field label="Trading opens"><DateTimeInput defaultValue="2026-09-12T10:00" label="Select pool opening date and time" /></Field>}</CreationSection>
